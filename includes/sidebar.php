...
<header class="side-header light-skin expand-header">
  ...
  <nav class="custom-scrollbar">
    <ul class="drp-sec">
      <li><a href="#" title=""><i class="ion-home"></i> Dashboard</a></li>
    </ul>
    <h4>Page</h4>
    <ul class="drp-sec">
    ...
    <h4>Coming Soon</h4>
    <ul class="drp-sec">
      <li class="has-drp"><a href="#" title=""><i class="fa fa-exclamation"></i> <span>Coming Soon</span></a>
        <ul class="sb-drp">
          <li><a href="#" title="">Coming Soon</a></li>
        </ul>
      </li>
      <li><a href="#" title=""><i class="fa fa-exclamation"></i> Coming Soon</a></li>
    </ul>
  </nav>
</header>
<!-- sidebar -->
